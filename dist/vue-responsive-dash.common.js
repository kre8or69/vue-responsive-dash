...
var update = add("2c4e45f2", content, true, {"sourceMap":false,"shadowMode":false});
...
// load the styles
var content = __webpack_require__(4172);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.id, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = (__webpack_require__(4402)/* ["default"] */ .Z)
var update = add("99fda074", content, true, {"sourceMap":false,"shadowMode":false});
...
/* harmony default export */ var DashItemvue_type_script_lang_ts = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    var emit = _ref.emit;
    var itemElement = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(); //This is the template ref we use for the element

    var item = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.reactive)(new DashItem(props));
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.provide)("$item", item);
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.watch)(props, function (newPropValue) {
    ...
    var layout = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.inject)("$layout");
    ...
    var addWatchersToLayout = function addWatchersToLayout() {
      ...
      if (layout) {
        ...
        var unWatch = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.watch)(layout, function (newValue) {
          if (newValue) {
    ...
    var dragging = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(false);
    ...
    var resizing = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(false);
    ...
    var hover = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(false);
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.watch)(hover, function (newValue) {
      item.hover = newValue;
    ...
    var resizingOrDragging = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return (resizing.value || dragging.value) && !props.locked;
    });
    var useCssTransforms = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      if (layout) {
    ...
    var left = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return item ? item.left : 0;
    });
    var top = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return item ? item.top : 0;
    });
    var widthPx = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return item ? item.widthPx : 0;
    });
    var heightPx = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return item ? item.heightPx : 0;
    });
    var cssStyle = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
    ...
    var resizeTop = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return !props.locked && props.resizable && props.resizeEdges.includes("top");
    });
    var resizeBottom = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return !props.locked && props.resizable && props.resizeEdges.includes("bottom");
    });
    var resizeLeft = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return !props.locked && props.resizable && props.resizeEdges.includes("left");
    });
    var resizeRight = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return !props.locked && props.resizable && props.resizeEdges.includes("right");
    });
    var resizeTopLeft = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return !props.locked && resizeTop.value && resizeLeft.value;
    });
    var resizeBottomLeft = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return !props.locked && resizeBottom.value && resizeLeft.value;
    });
    var resizeTopRight = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return !props.locked && resizeTop.value && resizeRight.value;
    });
    var resizeBottomRight = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
...
var DashItemvue_type_style_index_0_id_57f5f65e_scoped_true_lang_css = __webpack_require__(7669);
...
var DashLayoutvue_type_template_id_fd3379e0_scoped_true_ts_true_withScopeId = function _withScopeId(n) {
  return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.pushScopeId)("data-v-fd3379e0"), n = n(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.popScopeId)(), n;
};
...
function DashLayoutvue_type_template_id_fd3379e0_scoped_true_ts_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _ctx.currentBreakpoint === _ctx.breakpoint ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", DashLayoutvue_type_template_id_fd3379e0_scoped_true_ts_true_hoisted_1, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementVNode)("div", {
    style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.normalizeStyle)({
      position: 'relative',
      height: _ctx.height,
      width: _ctx.width
    ...
    _: 3
  }, 8, ["id", "y", "height", "maxWidth"]), [[external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.vShow, _ctx.dragging || _ctx.resizing]])], 4), _ctx.debug ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", DashLayoutvue_type_template_id_fd3379e0_scoped_true_ts_true_hoisted_3, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createTextVNode)(" Layout Breakpoint: " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(_ctx.breakpoint) + " ", 1), DashLayoutvue_type_template_id_fd3379e0_scoped_true_ts_true_hoisted_4, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createTextVNode)(" Layout Number of Cols: " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(_ctx.numberOfCols) + " ", 1), DashLayoutvue_type_template_id_fd3379e0_scoped_true_ts_true_hoisted_5, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createTextVNode)(" placeholder: " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(JSON.stringify(_ctx.placeholder)) + " ", 1), DashLayoutvue_type_template_id_fd3379e0_scoped_true_ts_true_hoisted_6, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createTextVNode)(" Items: " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(JSON.stringify(_ctx.itemsFromLayout)) + " ", 1), DashLayoutvue_type_template_id_fd3379e0_scoped_true_ts_true_hoisted_7, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createTextVNode)(" Height: " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(_ctx.height) + " ", 1), DashLayoutvue_type_template_id_fd3379e0_scoped_true_ts_true_hoisted_8, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createTextVNode)(" Attrs: " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toDisplayString)(_ctx.attrs), 1)])) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createCommentVNode)("", true)])) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createCommentVNode)("", true);
}
...
/* harmony default export */ var DashLayoutvue_type_script_lang_ts = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var layout = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.reactive)(new Layout(props));
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.provide)("$layout", layout);
    var dashboard = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.inject)("$dashboard");
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.onMounted)(function () {
      //Check if dashboard exists and if not then start a watcher
      if (dashboard) {
        dashboard.addLayoutInstance(layout);
      } else {
        var unWatch = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.watch)(dashboard, function (newValue) {
          if (newValue) {
    ...
    var currentBreakpoint = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return dashboard ? dashboard.currentBreakpoint : "";
    });
    var dragging = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return layout ? layout.itemBeingDragged : false;
    });
    var resizing = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return layout ? layout.itemBeingResized : false;
    });
    var placeholder = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
    ...
    var itemsFromLayout = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return layout ? layout.items : [];
    });
    var height = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
      return layout ? layout.height + "px" : "0px";
    });
    var width = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(function () {
    ...
    var placeholderId = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)("-1Placeholder");
    var placeholderY = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(0);
    var placeholderHeight = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(0);
    var placeholderMaxWidth = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(false);
    return {
      layout: layout,
...
var DashLayoutvue_type_style_index_0_id_fd3379e0_scoped_true_lang_css = __webpack_require__(4584);
...
function Dashboardvue_type_template_id_65ee42f8_ts_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", {
    id: _ctx.id,
    ref: "resizeRef"
  }, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.renderSlot)(_ctx.$slots, "default")], 8, Dashboardvue_type_template_id_65ee42f8_ts_true_hoisted_1);
}
...
var useResizeObserver = function useResizeObserver() {
  ...
  var resizeRef = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)();
  var resizeState = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.reactive)({
    dimensions: {
      bottom: undefined,
      height: undefined,
      left: undefined,
...
/* harmony default export */ var Dashboardvue_type_script_lang_ts = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    var emit = _ref.emit;
    var dashboard = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.reactive)(new Dashboard(props));
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.provide)("$dashboard", dashboard);
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.watch)(function () {
    ...
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.watch)(resizeState, function (newDimensions) {
